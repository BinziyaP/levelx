        ...
        <aside class="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 hidden md:block">
            <div class="h-full flex flex-col">
                ...
                <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('products.index') }}" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">
                        My Products
                    </a>
                    <a href="{{ route('products.create') }}" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">
                        Add New Product
                    </a>
                    <a href="{{ route('seller.orders') }}" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">
                        Orders
                    </a>
                    <a href="{{ route('seller.notifications') }}" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">
                        Notifications
                        <span class="ml-auto bg-red-500 text-white rounded-full px-2 text-xs">
