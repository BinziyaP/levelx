...
<div class="container mx-auto px-6 py-8">
    <h3 class="text-gray-700 dark:text-gray-200 text-3xl font-medium">Return Management</h3>
    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Review and resolve buyer–seller return cases.</p>
            ...
            <table class="min-w-full">
                <thead>
                    <tr>
                        ...
                        <th class="px-6 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-left text-xs leading-4 font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Seller</th>
                ...
                <tbody class="bg-white dark:bg-gray-800">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 dark:border-gray-700">
                            <div class="text-sm text-gray-900 dark:text-gray-100">{{ $dispute->buyer?->name ?? 'Unknown Buyer' }}</div>
                            <div class="text-xs text-gray-500">{{ $dispute->buyer?->email ?? 'N/A' }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 dark:border-gray-700">
                            <div class="text-sm text-gray-900 dark:text-gray-100">{{ $dispute->seller?->name ?? 'Unknown Seller' }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 dark:border-gray-700">
                            ...
                            @if($dispute->resolution_type)
                                <div class="text-xs text-gray-500 mt-1">{{ ucfirst(str_replace('_', ' ', $dispute->resolution_type)) }}</div>
                            @endif
                        </td>
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 dark:border-gray-700">
                            <a href="{{ route('admin.disputes.show', $dispute->id) }}" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">View Case →</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
