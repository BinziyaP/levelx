...
@section('content')
    <h3 class="text-gray-700 text-3xl font-medium mb-4">Add New Product</h3>
    ...
    <div class="p-6 text-gray-900 dark:text-gray-100">
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:border-gray-600 dark:text-gray-300" required></textarea>
            </div>
